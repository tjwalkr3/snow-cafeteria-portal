...
public static class DBSql
{
    public static readonly string SqlData = """
        ...
        CREATE TABLE
            cafeteria.order(
                ...
                total_swipe int4 NOT NULL DEFAULT 0,
                PRIMARY KEY (id)
            );
        ...
        CREATE TABLE
            cafeteria.food_item_option (
                ...
                PRIMARY KEY (id),
                FOREIGN KEY (food_item_order_id) REFERENCES cafeteria.food_item_order (id)
            );
        """;
    ...
    public static readonly string SqlDataWithSampleData =
        ...
        + """
            ...
            INSERT INTO cafeteria.cafeteria_location (id, location_name, location_description, image_url)
            VALUES 
                (1, 'Badger Den', 'Located on the main floor of the Greenwood Student Center', 'https://picsum.photos/id/292/300/200'),
                (2, 'Busters Bistro', 'Located on the main floor of the Karen H Huntsman Library', 'https://picsum.photos/id/326/300/200'),
                (3, 'Test Location', 'For read-only tests', 'https://picsum.photos/id/100/300/200');
            ...
            INSERT INTO cafeteria.order (id, total_price, total_swipe)
            VALUES
                (1, 12.98, 0),
                (2, 0, 1);

            -- Food Item Orders (IDs 1-20 reserved for sample data)
            INSERT INTO cafeteria.food_item_order (id, order_id, station_id, swipe_cost, card_cost, special)
            VALUES
                (1, 1, 1, NULL, 8.99, false),
                (2, 1, 1, NULL, 3.99, false),
                (3, 2, 2, 1, NULL, true);
            ...
            SELECT setval('cafeteria.food_item_order_id_seq', 100, false);
