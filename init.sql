...
INSERT INTO
    cafeteria.cafeteria_location (location_name, location_description, icon_name, printer_url)
VALUES
    (
        'Badger Den',
...
INSERT INTO
    cafeteria.station (location_id, station_name, station_description, icon_name)
VALUES
    (1, 'Breakfast', 'Hot breakfast entrees and sides', 'bi-cup-hot-fill'),
    (1, 'Deli', 'Fresh made-to-order sandwiches', 'bi-egg-fried'),
    (1, 'Grill', 'Hot entrees and burgers', 'bi-fire'),
    (
        1,
        'Pizza',
    ...
    (2, 'Wraps', 'Fresh wraps and healthy options', 'bi-tornado');
