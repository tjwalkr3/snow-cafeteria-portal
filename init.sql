...
CREATE TABLE cafeteria.food_option_type (
  ...
  icon_id int4,
  PRIMARY KEY (id),
  FOREIGN KEY (entree_id) REFERENCES cafeteria.entree (id) ON DELETE CASCADE,
  FOREIGN KEY (side_id) REFERENCES cafeteria.side (id) ON DELETE CASCADE,
  FOREIGN KEY (icon_id) REFERENCES cafeteria.icon (id)
);
...
CREATE TABLE cafeteria.option_option_type (
  ...
  PRIMARY KEY (id),
  FOREIGN KEY (food_option_id) REFERENCES cafeteria.food_option (id) ON DELETE CASCADE,
  FOREIGN KEY (food_option_type_id) REFERENCES cafeteria.food_option_type (id) ON DELETE CASCADE
);
