...
INSERT INTO cafeteria.food_item (id, station_id, item_description, item_price) VALUES
    (1, 1, 'Pretzel Bun Sandwich', 5.99),
    (2, 1, 'Marble Rye Sandwich', 5.99),
    (3, 1, 'Sourdough Sandwich', 5.99),
    (4, 1, 'Wheat Sandwich', 5.99),
    (5, 1, 'Garlic Flat Bread Sandwich', 5.99),
    (6, 1, 'White Bread Sandwich', 5.99),
    (7, 1, 'Salad', 4.99),

    (8, 2, 'Hamburger', 4.49),
    (9, 2, 'Cheeseburger', 4.99),
    (10, 2, 'Double Cheeseburger', 6.29),
    (11, 2, 'Bacon Cheeseburger', 5.49),
    (12, 2, 'Double Bacon Cheeseburger', 6.89),
    (13, 2, 'Turkey Burger', 5.29),
    (14, 2, 'Veggie Burger', 4.89),
    (15, 2, 'Grilled Chicken Sandwich', 5.19),
    (16, 2, 'Grilled Chicken Breast', ),
    (17, 2, 'Breaded Chicken Breast', ),
    (18, 2, 'Breaded Chicken Sandwich', 5.19),
    (19, 2, 'Philly Cheesesteak', 6.89),
    (20, 2, 'Chicken Cheesesteak', 6.79),
    (21, 2, 'Badger Burger', 5.49),
    (22, 2, 'BLT', 4.89),
    (23, 2, 'Fish Fillet', 5.49),
    (24, 2, 'Fish Fillet Sandwich', 5.99),
    (25, 2, 'Grilled Cheese', 3.29),
    (26, 2, 'Grilled Cheese and Ham', 4.29),
    (27, 2, 'Cheese Quesadilla', 3.99),
    (28, 2, 'Chicken Quesadilla', 5.29),
    (29, 2, 'Steak Quesadilla', 5.49),
    (30, 2, 'French Fries', 1.99),
    (31, 2, 'Waffle Fries', ),
    (32, 2, 'Onion Rings', 2.49),
    (33, 2, 'Tater Tots', 1.99),
    (34, 2, 'Corn Dog', 2.89),
    (35, 2, 'Chicken Nuggets', 4.99),
    -- No Grilled Chicken breast, breaded chicken breast price

    (36, 3, 'Single Pizza', 4.89),
    (37, 3, 'Large Pizza', 9.49),

    (38, 4, 'Breakfast Plate', 4.99),
    (39, 4, 'Omelet', 3.89),
    (40, 4, 'Breakfast Sandwich', 3.49),
    (41, 4, 'Breakfast Burrito', 4.99),
    (42, 4, 'Side of Two Eggs', 2.89),
    (43, 4, 'French Toast', 4.89),
    (44, 4, 'Pancake', 2.99),
    (45, 4, '2 Pancakes', 3.99),
    (46, 4, 'Bacon', 2.19),
    (47, 4, 'Sausage', 2.19),
    (48, 4, 'Potatoes', 1.49),
    (49, 4, 'Tater Tots', ),
    (50, 4, 'Toast', 1.49)
    -- No Side of ham, hashbrowns on sheet
    -- No Tatter Tots on pricing
