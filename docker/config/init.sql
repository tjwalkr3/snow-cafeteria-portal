...
CREATE TABLE cafeteria.order_detail_builder (
    id int4 GENERATED BY DEFAULT AS IDENTITY,
    food_item_id int4 NOT NULL,
    ingredient_id int4 NOT NULL,
    ingredient_type_id int4 NOT NULL,
    ingredient_count int4 NOT NULL,
    extra_ingredient_price int4 NOT NULL,
    PRIMARY KEY (id),
    FOREIGN KEY (food_item_id) REFERENCES cafeteria.food_item(id),
    FOREIGN KEY (ingredient_id) REFERENCES cafeteria.ingredient(id),
    FOREIGN KEY (ingredient_type) REFERENCES cafeteria.ingredient_type(id)
);

CREATE TABLE cafeteria.order_detail (
    id int4 GENERATED BY DEFAULT AS IDENTITY,
