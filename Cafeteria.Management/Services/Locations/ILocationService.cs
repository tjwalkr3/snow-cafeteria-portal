...
public interface ILocationService
{
    ...
    Task CreateLocation(string name, string? description, string? iconName = null);
    Task UpdateLocation(int locationId, string name, string? description, string? iconName = null);
