...
public interface ILocationService
{
    ...
    Task CreateLocation(string name, string? description, int? iconId = null, string? printerUrl = null);
    Task UpdateLocation(int locationId, string name, string? description, int? iconId = null, string? printerUrl = null);
